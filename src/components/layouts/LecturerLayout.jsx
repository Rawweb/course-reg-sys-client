...
import { LogOut, LayoutDashboard, ClipboardCheck, Settings, Menu, X } from 'lucide-react';
      ...
      <div className='flex-1 flex flex-col overflow-hidden'>
        <header className='bg-surface border-b border-border px-4 sm:px-8 py-4 flex items-center justify-between flex-shrink-0'>
          <div className='flex items-center gap-3'>
            ...
            <p className='text-sm text-text-muted'>{user?.department?.name || 'Lecturer'} Panel</p>
          </div>
